...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var rows = Array.from(document.querySelectorAll('#recent-table tbody tr.recent-row'));
    var paginationBar = document.getElementById('pagination-recent');
    ...
    function renderPagination() {
        ...
        infoWrapper.style.cssText = 'width:100%; text-align:center; margin-top:6px;';
        ...
        paginationBar.appendChild(infoWrapper);
    }
